...
namespace Navigation
{
	public class HeightRangeCost : ICostStrategy
	{
		...
		public SparseVoxelOctree SVO { get; set; }

		public Dictionary<uint, float> GScore { get; set; }

		public Dictionary<uint, float> FScore { get; set; }

		public Dictionary<uint, uint> CameFrom { get; set; }

		private Dictionary<uint, float[]> HeightScore { get; set; }

		public List<uint> TotalPath { get; set; }
