...
namespace Trees
{
	...
	public class SparseVoxelOctree
	{
		...
		public struct SparseNode
		{
			...
			public SparseNode(int layer, uint mortonCode, uint nodeInd, uint subNodeIndex)
			{
				parent = 0u;
				firstChild = 0u;
				neighbors = null;
		...
		public struct Layer
		{
			...
			public Layer(int nbNodes, int nbLayers, int layerInd, int finalResolution)
			{
				nodes = null;
				cubeSize = 0;
				gridSize = 0;
