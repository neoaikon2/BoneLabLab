...
namespace SLZ.SFX
{
	public class SimpleSFX : MonoBehaviour
	{
		...
		private void AUDIOPLAY(int clipSpecific = 0, PlayBehavior behavior = PlayBehavior.order, AudioClip clipOverride = default(AudioClip), Transform location = default(Transform))
		{
		}
