...
namespace SLZ.Marrow.Audio
{
	...
	public class ManagedAudioPlayer
	{
		...
		public void PlayAtPoint(AudioClip clip, Vector3 position, AudioMixerGroup mixerGroup, float volume = 1f, float pitch = 1f, float? pitchRng = default(float?), float minDistance = 1f, float spatialBlend = 0.98f)
		{
		}

		public void PlayAtPoint(AudioClip[] clips, Vector3 position, AudioMixerGroup mixerGroup, float volume = 1f, float pitch = 1f, float? pitchRng = default(float?), float minDistance = 1f, float spatialBlend = 0.98f)
		{
		}

		public void PlayAtPoint(AudioClip[] clips, AudioClip[] clipsHalfMo, Vector3 position, AudioMixerGroup mixerGroup, float volume = 1f, float pitch = 1f, float? pitchRng = default(float?), float minDistance = 1f, float spatialBlend = 0.98f)
		{
		}
		...
		public void PlayAtLocalPoint(AudioClip clip, Transform parent, Vector3 localPosition, AudioMixerGroup mixerGroup, float volume = 1f, float pitch = 1f, float? pitchRng = default(float?), float minDistance = 1f, float spatialBlend = 0.98f)
		{
		}

		public void PlayAtLocalPoint(AudioClip[] clips, Transform parent, Vector3 localPosition, AudioMixerGroup mixerGroup, float volume = 1f, float pitch = 1f, float? pitchRng = default(float?), float minDistance = 1f, float spatialBlend = 0.98f)
		{
		}

		public void PlayAtLocalPoint(AudioClip[] clips, AudioClip[] clipsHalfMo, Transform parent, Vector3 localPosition, AudioMixerGroup mixerGroup, float volume = 1f, float pitch = 1f, float? pitchRng = default(float?), float minDistance = 1f, float spatialBlend = 0.98f)
		{
		}
