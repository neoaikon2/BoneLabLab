...
namespace SLZ.VRMK
{
    public partial class Avatar : MonoBehaviour
    {
        public virtual void OnDrawGizmosSelected()
        {
            ...
            DrawLimb(animator.GetBoneTransform(HumanBodyBones.LeftUpperArm), animator.GetBoneTransform(HumanBodyBones.LeftLowerArm), wristLf, _upperarmEllipse, _elbowEllipse, _forearmEllipse, _wristEllipse, Mathf.LerpUnclamped(.03f / humerousLfLength, 1f, .1f), 1f, .18f, 1f, eyeCenterHeight, true);
            ...
            DrawLimb(animator.GetBoneTransform(HumanBodyBones.RightUpperArm), animator.GetBoneTransform(HumanBodyBones.RightLowerArm), wristRt, _upperarmEllipse, _elbowEllipse, _forearmEllipse, _wristEllipse, Mathf.LerpUnclamped(.03f / humerousRtLength, 1f, .1f), 1f, .18f, 1f, eyeCenterHeight);
            ...
            DrawLimb(animator.GetBoneTransform(HumanBodyBones.RightUpperLeg), animator.GetBoneTransform(HumanBodyBones.RightLowerLeg), animator.GetBoneTransform(HumanBodyBones.RightFoot), _thighUpperEllipse, _kneeEllipse, _calfEllipse, _ankleEllipse, Mathf.LerpUnclamped(_crotchBottom / femurRtLength, 1f, .1f), 1f, .3f, 1f, eyeCenterHeight);
        }
