...
namespace SLZ.Marrow.Pool
{
	public class Pool
	{
		...
		public Pool(SpawnableCrate sc, Transform rootTransform = default(Transform))
			: base()
		{
		}

		internal UniTask<Poolee> Spawn(Vector3 position = default(Vector3), Quaternion rotation = default(Quaternion), Vector3? scale = default(Vector3?), bool forceInstantiation = false)
		{
