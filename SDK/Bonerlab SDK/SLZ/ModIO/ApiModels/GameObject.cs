...
namespace SLZ.ModIO.ApiModels
{
	...
	public struct GameObject
	{
		...
		{
			this.Platforms = default(IReadOnlyList<GamePlatformsObject>);
			this.Theme = default(ThemeObject);
			this.Stats = default(GameStatsObject);
			this.TagOptions = default(IReadOnlyList<GameTagOptionObject>);
			this.OtherUrls = default(IReadOnlyList<GameOtherUrlsObject>);
			this.ProfileUrl = default(string);
			this.InstructionsUrl = default(string);
			this.Instructions = default(string);
			this.Summary = default(string);
			this.NameId = default(string);
			this.Name = default(string);
			this.Header = default(HeaderImageObject);
			this.Logo = default(LogoObject);
			this.Icon = default(IconObject);
			this.UgcName = default(string);
			this.MaturityOptions = default(int);
			this.ApiAccessOptions = default(int);
			this.RevenueOptions = default(int);
			this.CurationOption = default(int);
			this.SubmissionOption = default(int);
			this.MonetisationOptions = default(int);
			this.CommunityOptions = default(int);
			this.PresentationOption = default(int);
