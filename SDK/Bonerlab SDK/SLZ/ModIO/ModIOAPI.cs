...
namespace SLZ.ModIO
{
	public sealed class ModIOAPI : IDisposable
	{
		...
		[PublicAPI]
		public Task<Result<AccessTokenObject>> SteamAuth(string appTicketBase64, string email = default(string), long? dateExpires = default(long?), bool? termsAgreed = default(bool?), int retryCount = 5, RequestContext context = default(RequestContext), CancellationToken token = default(CancellationToken))
		{
			return null;
		}
