...
namespace PuppetMasta
{
	...
	public class SubBehaviourSensors : SubBehaviourBase
	{
		...
		[Header("Vision")]
		public LayerMask blockVisionRaycast = 8192;

		public float visionFov = 80.0f;

		[Header("Hearing")]
		public float hearingSensitivity = 0.0f;

		[Header("Touch")]
        [Tooltip("Set these to the bone(s) that touches the ground")]
		public MuscleCollisionBroadcasterSensor[] forceSensorsFeet;

        [Tooltip("Set these to the hand bone(s)")]
		public MuscleCollisionBroadcasterSensor[] forceSensorsHands;

        [Tooltip("Set these to the main body bone(s)")]
