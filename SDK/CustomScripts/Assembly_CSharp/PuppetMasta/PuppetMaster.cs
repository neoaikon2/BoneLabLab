...
namespace PuppetMasta
{
	...
	public class PuppetMaster : MonoBehaviour
	{
        ...
        public StateSettings stateSettings;// = new StateSettings(.75f, 0.01f, 200.0f, 0.02f, true, true);
